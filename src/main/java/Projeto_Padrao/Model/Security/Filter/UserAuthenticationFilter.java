package Projeto_Padrao.Model.Security.Filter;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (checkIfEndpointIsNotPublic(request)) {
            ...
            if (token != null) {
                ...
                Administrador administrador = admRepository.findByEmail(subject); // Busca o usuário pelo email (que é o assunto do token)
                UserDetailsImpl userDetails = new UserDetailsImpl(administrador); // Cria um UserDetails com o usuário encontrado
